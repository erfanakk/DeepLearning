...
from model_builder import Generator, Critic
import torchvision
...
utils.load_checkpoint(torch.load('WGANMODEL.pth.tar' , map_location=torch.device('cpu')), modelGEN=generat, modelDIS=dis )
